...
<head>
    ...
    <title>Nonomy MCP — Dashboard</title>
    ...
    <div class="shell">
        ...
        <header class="header">
            <div class="header-left">
                ...
                <div class="logo-text">Nonomy <span>MCP</span></div>
            </div>
        ...
        <!-- Footer -->
        <footer class="footer">
            Nonomy MCP Server · Port ${String(WS_PORT)} · <a href="https://github.com/notpoiu/roblox-mcp" target="_blank" rel="noopener">GitHub</a>
        </footer>
    </div>
